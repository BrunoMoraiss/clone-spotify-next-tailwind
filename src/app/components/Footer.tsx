  ...
  return (
    <footer className="bg-zinc-900 border-t border-zinc-700 px-6 py-4 flex items-center justify-between">
      <div className='flex items-center gap-2'>
        <Image src="/img.jpg" alt="Capa do Album Victor e Léo Irmãos" width={56} height={56} />
        <div className='flex flex-col'>
          <strong className='font-normal'>Radioctive</strong>
          <span className='text-sm text-zinc-400'>Imagine Dragons</span>
        </div>
      </div>
